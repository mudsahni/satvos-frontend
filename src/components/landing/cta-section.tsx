        ...
        >
          ...
          <div className="relative px-6 py-16 md:py-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/login"
                className="group inline-flex items-center justify-center gap-2 rounded-lg bg-white px-6 py-3 text-sm font-semibold text-slate-900 transition-all hover:bg-white/90 hover:shadow-xl hover:-translate-y-0.5"
              >
                Start Free Trial
