...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        // Soft shadows for light mode (Notion/Stripe inspired)
        ...
        // Card shadow with subtle border effect
        card: "0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1), 0 0 0 1px rgb(0 0 0 / 0.05)",
        "card-hover":
          "0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1), 0 0 0 1px rgb(0 0 0 / 0.05)",
        // Glow shadows for dark mode (kept for compatibility)
        "glow-sm": "0 0 10px -3px hsl(var(--primary) / 0.3)",
        "glow-md": "0 0 20px -5px hsl(var(--primary) / 0.4)",
        "glow-lg": "0 0 30px -5px hsl(var(--primary) / 0.5)",
        "glow-success": "0 0 15px -5px hsl(var(--success) / 0.5)",
        "glow-warning": "0 0 15px -5px hsl(var(--warning) / 0.5)",
        "glow-error": "0 0 15px -5px hsl(var(--error) / 0.5)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
